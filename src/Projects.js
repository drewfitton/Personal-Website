...
const projects = [
  { id: 0, title: 'Stock Performance Predictor', techstack: 'Angular | Python | FastAPI | scikit-learn | PostgreSQL | Yahoo Finance API', projectLink: "", github_link: "https://github.com/drewfitton/StockAppAngular", description: "The Stock Performance Predcitor is a personal project I developed that leverages a Machine Learning model to indicate buy and sell signals to the S&P 500 stocks at the end of each trading day. I developed the user interface in Angular, and connected it to a FastAPI backend that serves ML model predictions that leverage a BagLearner consisting of 20 Random Forest classifiers. The model is trained on a variety of technical indicators as well as revenue data. Leveraging this app followed by more in-depth research, I've achieved a return rate of 20% across 6 months of small-scale trading.", image: stockApp},
